...
%[x fs]=wavread('record/lichuan.wav');
%[x fs]=wavread('record/li.wav');
%[x fs]=wavread('record/autman.wav');
%[x fs]=wavread('record/wangxiang.wav');
...
subplot(2,1,1);  
ccc_1=ccc(:,1);  
%plot(ccc_1);title('lc-MFCC');ylabel('幅值');  
%plot(ccc_1);title('llx-MFCC');ylabel('幅值');  
%plot(ccc_1);title('autman-MFCC');ylabel('幅值');  
%plot(ccc_1);title('wangxiang-MFCC');ylabel('幅值');  
plot(ccc_1);title('zhusongkai-MFCC');ylabel('幅值');  
[h,w]=size(ccc);  
A=size(ccc);  
subplot(2,1,2);  
plot([1,w],A);  
